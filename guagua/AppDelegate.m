...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //set init view
    WelcomeViewController *initView = [[WelcomeViewController alloc] init];
    //添加NavBar
    UINavigationController * navController = [[UINavigationController alloc] initWithRootViewController:initView] ; //初始化导航栏控制器
    //设置navBar属性
    if(systemVersion>=7)
    {
        //navBar背景颜色
        ...
        initView.edgesForExtendedLayout = UIRectEdgeNone;
